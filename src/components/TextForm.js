        ...
        <>
            <div className='container' style={{color: props.mode==='dark'?'white':'black'}}>
                <div className="mb-3">
                    <h1>{props.heading}</h1>
                    <div className='mb-3'>
                        <textarea className="form-control" value={text} style={{backgroundColor:props.mode==='dark'?'#3f6a91':'white',color: props.mode==='dark'?'white':'black'}} onChange={HandleChange} id="myBox" rows="6"></textarea>
                    </div>
